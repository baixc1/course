...
export default class CustomLayout3 extends Component {
  static displayName = 'CustomLayout3';
    ...
    return (
      <Layout
        ...
        className={cx(`ice-design-custom-layout-${theme}`, {
          'ice-custom-layout3': true,
          'aside-collapse': this.state.collapse,
          // 'ice-design-header-fixed': true,
          // 'ice-design-footer-fixed': false,
        })}
      >
        <Header
          className={cx({
            'ice-custom-layout3-header': true,
          })}
          theme={theme}
        ...
        <Layout.Section
          scrollable
          className={cx({
            'ice-custom-layout3-main-section': true,
            'ice-custom-layout3-main-section-open-drawer': this.state
              .openDrawer,
            'ice-custom-layout3-main-section-collapse': this.state.collapse,
          })}
        >
